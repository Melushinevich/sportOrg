...
class MainApplication(QStackedWidget):
    def __init__(self):
        ...
        self.addWidget(self.sportsman_window)  # индекс 2
        self.addWidget(self.trainer_window)  # индекс 3
    ...
    def on_go_to_login(self):
        """Переход из стартового окна в окно входа (пока заглушка)"""
        print("Функция входа будет реализована позже")
        # TODO: Создать окно входа
    ...
    def go_to_start(self):
        """Вернуться на стартовое окно (можно добавить кнопку)"""
        self.setCurrentWidget(self.start_window)
