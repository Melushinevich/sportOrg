        ...
        return jsonify(
            {
                ...
                "endpoints": {
                    ...
                    "my_teams": "GET /api/v1/me/teams (Bearer, sportsman)",
                    "coach_teams": "GET|POST /api/v1/coach/teams (Bearer, coach)",
                    "coach_sports": "GET /api/v1/coach/sports (Bearer, coach)",
                    "coach_skills_catalog": "GET /api/v1/coach/skills-catalog (Bearer, coach)",
