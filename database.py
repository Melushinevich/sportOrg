...
class Database:
    ...
    def _insert_skills(self, cursor):
        ...
        skills = [
            ...
            ('Лидерство', 'team', 'Способность вести за собой команду'),
            ('Прыгучесть', 'physical', 'Высота прыжка'),
            ('Реакция', 'physical', 'Быстрота ответной реакции'),
            ('Гибкость', 'physical', 'Подвижность суставов, растяжка'),
            ('Спортивное поведение', 'psychological', 'Умение общаться с судьями'),
            ('Амбициозность', 'personal', 'Стремление к высоким результатам'),
